...
This project is a part of my workbook from Full stack developers course at BIT This is the 7th part of the course. Pratcice No.1 React page design.

This project is for educational porpuses only. Pull request are welcome, but priority for project authors! Thank you for your cooperation!

Design from [this template](https://dribbble.com/shots/16203931/attachments/8064185?mode=media) 

View deployed result on [my github](https://madrakas.github.io/bit_07_01_homework_simple-react-page-design/)
...
7. [React intro. Initialisation](https://github.com/madrakas/bit_07_react_intro)
    1. Practice No.1. React page design (current repository)
8. 
...
*   Learn:
    ...
    *   Design html structure under React enviroment
    *   React project deployment in Github pages
